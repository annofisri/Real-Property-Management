...
$objPost->section = 'hero-testimonal'; // section is required
            ...
            <div class="user-list-wrapper">
              <div class="head">
                ...
                <div class="btn-global">
                  <a href="/cpanel/hero-testimonal/new" class="btn btn-outline-primary">Add New</a>
                </div>
              </div>
                    ...
                    <tbody>
                      <?php
                            ...
                            foreach($section_lines as $key){
                              ...
                              <td>
                              <a href="/cpanel/hero-testimonal_edit?id='.$key["id"].'">edit</a>
