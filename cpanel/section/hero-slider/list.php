...
$objPost->section = 'hero-slider'; // section is required
            ...
            <div class="user-list-wrapper">
              <div class="head">
                ...
                <div class="btn-global">
                  <a href="/cpanel/hero-slider/new" class="btn btn-outline-primary">Add New</a>
                </div>
              </div>
                    ...
                    <tbody>
                      <?php
                            ...
                            foreach($section_lines as $key){
                              ...
                              <td>
                              <a href="/cpanel/hero-slider_edit?id='.$key["id"].'">edit</a>
