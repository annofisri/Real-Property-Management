...
if (isset($_POST["btnCreate"])) {
  ...
  $objPost = new Post();
  // var_dump($_POST);
  $objPost->section = 'service'; // section is required for all post operations
        ...
        <div class="post-add-wrapper border p-4 w-50">
          <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control rich-text-editor" rows="10" id="long_description"
            ...
            <select class="form-select mb-3" name="visibility">
              ...
              <option value="public" <?php echo ($data['visibility'] == "Public" ? 'selected' : "") ?>>
                Public</option>
              <option value="private" <?php echo ($data['visibility'] == "Private" ? 'selected' : "") ?>>
                Private</option>
            </select>
